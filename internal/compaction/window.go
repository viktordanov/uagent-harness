...
// windows are the context windows from Codex's model table
// (codex-rs/models-manager/models.json).
var windows = map[string]int64{
	"gpt-daybreak-red-latest": 372_000,
}

// ContextWindow is the model's context window in tokens: override when it is
// positive, else the table's value, else DefaultContextWindow.
